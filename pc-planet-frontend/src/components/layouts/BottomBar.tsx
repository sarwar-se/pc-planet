...
import { BsFillLightningFill, BsFillPersonFill, BsFillGiftFill } from 'react-icons/bs';
...
const BottomBar = () => {
  return (
    <>
      <Navbar fixed='bottom' bg='light' className='d-xl-none py-0 border-top fw-bold bottom-bar'>
